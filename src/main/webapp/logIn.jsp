        ...
        <div class="row mt-5 ">
            <div class="col-12 m-auto">
                <div style="text-align: center;margin-top: 100px;">
                    <h2 class="">Log in</h2>
                    <p class="">If you don,t have an account?<a href="signUp.jsp">Sign Up</a></p>
                </div>
                <%
String msg=request.getParameter("msg");
if("notexist".equals(msg)){%>

<h1 style="color:red;text-align:center;">userName and Password are correct </h1>
...
<%} %>
                <div class="row">
                    ...
                    <div class="col-6 margdinlogin">
                        <form class="needs-validation" novalidate action="logInAction.jsp">
